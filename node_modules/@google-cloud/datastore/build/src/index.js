...
const buildPropertyTransforms_1 = require("./utils/entity/buildPropertyTransforms");
    ...
    save(entities, gaxOptionsOrCallback, cb) {
        ...
        entities
            ...
            if (entityObject.transforms) {
                mutation.propertyTransforms = (0, buildPropertyTransforms_1.buildPropertyTransforms)(entityObject.transforms);
            }
